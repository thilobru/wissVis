...
void main( void )
{
    ...
    for( int cornerId = 0; cornerId < 4; ++cornerId )
    {
        ...
        frag_rayStart = homog( screenToWorld * vec4( screenPos.xy / screenPos.w, -1.0f, 1.0 ) );
        frag_rayEnd = homog( screenToWorld * vec4( screenPos.xy / screenPos.w, 0.0f, 1.0 ) );
