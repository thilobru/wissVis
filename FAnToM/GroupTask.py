...
fantom.ui.setCamera( 2, fantom.ui.Camera( fantom.math.Vector3(0, -5.7253, 0), fantom.math.Vector3(0, -3.33786e-06, 0), fantom.math.Vector3(0, 0, 1), 0, 1.0472 ) )
...
Tasks_GroupTask.setOption("oz", 0.5)
Tasks_GroupTask.setOption("nx", 1)
Tasks_GroupTask.setOption("ny", 1)
Tasks_GroupTask.setOption("nz", 6)
