...
###                  Reset GUI                               ###
################################################################
fantom.ui.setCamera( 0, fantom.ui.Camera( fantom.math.Vector3(-0.401299, 1.57304, 4.77874), fantom.math.Vector3(2.12834, -0.304203, 0.393207), fantom.math.Vector3(0.0658499, 0.930501, -0.360322), 1, 1.0472 ) )
...
Tasks_GTStartlineGradual.setOption("sz", 3)
Tasks_GTStartlineGradual.setOption("ex", -4)
Tasks_GTStartlineGradual.setOption("ey", 4)
Tasks_GTStartlineGradual.setOption("ez", 3)
