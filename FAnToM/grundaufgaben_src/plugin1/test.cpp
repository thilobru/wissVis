...
//         static void makeTriangle(std::set<Point<3>> &surfacePointsSet, 
//                                  std::vector<unsigned int> &surfaceIndexes, 
//                                  Point<3> &p1, Point<3> &p2, Point<3> &p3) {
//             // PointF<3> addPoint[] = {(PointF<3>) p1, 
//             //                         (PointF<3>) p2, 
//             //                         (PointF<3>) p3};
//             // std::vector<PointF<3>> addPoint;
//             // addPoint.push_back((PointF<3>) p1);
//             // addPoint.push_back((PointF<3>) p2);
//             // addPoint.push_back((PointF<3>) p3);
//             for(size_t i = 0; i < 3; i++) {
//                 surfacePointsSet.insert(p3);//addPoint[i]);
...
//                                 size_t nL, 
//                                 std::set<Point<3>> &surfacePointsSet, 
//                                 std::vector<unsigned int> &surfaceIndexes) {
//             float prevDiag = 100;//INFINITY;
//             bool caughtUp = false;
//             while(true) {
...
//                 if(caughtUp && (advanceOnLeft || rDiag > prevDiag)) return;
//                 if (advanceOnLeft) {
//                     makeTriangle(surfacePointsSet, 
//                                  surfaceIndexes, 
//                                  l0, r0, l1);
//                     posFront[nL]++;
//                     caughtUp = true;
...
//             advanceRibbon(streamList, posFront, 0, surfacePointsSet, surfaceIndexes);
